...
- Manual human onboarding or product sign-off procedures (belongs in `acceptance.md`).
- Broad release acceptance criteria and scenario checklists (belongs in `acceptance.md`).
