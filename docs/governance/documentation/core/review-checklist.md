...
- Active domain profiles obey their respective boundaries:
  - Validation: `acceptance.md` verifies outside-in deliverables, user journeys, and acceptance scenario matrices;
    `testing.md` covers inside-out programmatic implementation and test suites.
